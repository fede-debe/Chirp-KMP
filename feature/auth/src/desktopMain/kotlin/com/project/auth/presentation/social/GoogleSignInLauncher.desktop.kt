...
/**
 * Social sign-in isn't offered on desktop (`canUseGoogleSignIn` stays false there). This actual exists
...
actual fun rememberGoogleSignInLauncher(
    ...
    return remember(onResult) {
        SocialSignInLauncher {
            onResult(SocialSignInResult.Failure("Google sign-in is not available on desktop"))
        }
    }
}
